...
* **`python/playwright-practice/`**: Скрипты автоматизации пользовательского интерфейса, демонстрирующие обработку iframe, динамическую прокрутку и многое другое.
* **`python/selenium-practice/`**: Скрипты автоматизации пользовательского интерфейса с использованием архитектуры Page Object Model (POM), фикстур pytest и параметризации, отличающиеся надежной явной синхронизацией и обособленными проверками.
...
### 3. Автоматизация веб-интерфейса (Playwright, Selenium & Python)
